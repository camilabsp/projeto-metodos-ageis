...
class app(funcoes):
    ...
    def widgets_frame2(self):
        ...
        #tabela de dados
        self.tabela_dados = ttk.Treeview(self.frame2,height = 11,column = ('col1','col2','col3','col4','col5','col6','col7','col9','col10','col11','col12'))
        ...
        self.tabela_dados.heading('#11',text='L/P')

        self.tabela_dados.column('#0',width=0)
        self.tabela_dados.column('#1',width=60,anchor='center')
        self.tabela_dados.column('#2',width=50, anchor='center')
        self.tabela_dados.column('#3',width=40,anchor='center')
        self.tabela_dados.column('#4',width=55,anchor='center')
        self.tabela_dados.column('#5',width=30,anchor='center')
        self.tabela_dados.column('#6',width=55,anchor='center')
        self.tabela_dados.column('#7',width=55,anchor='center')
        self.tabela_dados.column('#8',width=45,anchor='center')
        self.tabela_dados.column('#9',width=60,anchor='center')
        self.tabela_dados.column('#10',width=65,anchor='center')
        self.tabela_dados.column('#11',width=50,anchor='center')
    ...
    def table1(self):
        ...
        self.tabela_soma.column('#1',width=130,anchor='center')
    ...
    def janela2(self):
        ...
        self.tabela_dados.column('#9',width=60,anchor='center')
        self.tabela_dados.column('#10',width=65,anchor='center')
        self.tabela_dados.column('#11',width=40,anchor='center')
        self.tabela_dados.column('#12',width=60,anchor='center')
